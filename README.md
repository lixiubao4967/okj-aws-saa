...
> 📉 **2026-09-14 混合卷① 第 1 批：14/22（63.6%）** —— 分模块 93-100% → 混合长题干 64%，落差 29 个点。
...
1. **买 Tutorials Dojo SAA-C03 模拟题（约 $15）** —— 现在性价比最高的一步，理由见下
2. 做 Claude 出的 **65 题混合模拟卷**（跨域混合，适应切换）
3. 模拟卷① → 错题精读 → 卷② → 薄弱域专项 → 卷③（可加到 4-5 套）
4. **决策关卡 9/20**：若模拟卷① 正确率 < 70%，免费改期到 10/3
